...
class _MainScreenState extends ConsumerState<MainScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: PageView(
          ...
          children: [
            _buildDashboardPage(context, theme),
            _buildControlPage(context, theme),
  ...
  Widget _buildDashboardPage(BuildContext context, ThemeData theme) {
  ...
  Widget _buildEnvironmentInfo(ThemeData theme, double temp, String iconName) {
    IconData icon;
  ...
  Widget _buildControlPage(BuildContext context, ThemeData theme) {
    return Column(
      children: [
        const SizedBox(height: 20),
        Padding(
