...
import '../voice/voice_assistant_overlay.dart';
          ...
          child: BackdropFilter(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: const _SuperSegmentScenes()),
                    SizedBox(width: 16 * scale),
...
class _SuperSegmentScenes extends ConsumerWidget {
  const _SuperSegmentScenes();
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return _SuperActionItem(
